...
![image of biden's website title modified](/assets/img/aireg_1.png)
...
The rule must be regulating a *something*. So it either regulates the code itself or the weights. However, to regulate either would be a speech content restriction.

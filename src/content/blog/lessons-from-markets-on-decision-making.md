...
title: Lessons from Markets on Decision Making
...
tags:
  ...
  - economics
ogImage: ""
description: "Exploring how market principles apply to life decisions - from understanding utility functions and value systems to finding your edge in competitive environments."
---
...
- the goal is excess returns _independent_ of what everyone else does (the market)
...
The seller only sets the price. 
As the taker, you set the time AND the price. 
...
I guess that means everyone in Hong Kong should be trading on the [NEPSE](https://www.nepalstock.com). There are probably good reasons that isn't happening but that's beside the point.
